...
export const ProjectNavigator = (props: any): React.ReactElement => {
  ...
  return (
    <div
      className="v2-project-navigator"
      style={{ height: `${size}px`, width: `${size}px` }}
    >
      <img
        className="v2-project-navigator-bg"
        src={NavigatorImage}
        alt="NavigatorImage"
      />
      <div className="v2-project-navigator-cover">
        <div
          className="v2-project-navigator-container"
          ...
          {elementList.map((e, index) => (
            <div
              ...
              style={{
                top:
                  (size / 2) *
                    (1 - Math.cos((Math.PI * (angle * index)) / 180)) +
                  'px',
                left:
                  (size / 2) *
                    (1 - Math.sin((Math.PI * (angle * index)) / 180)) +
                  'px',
              }}
            >
