...
function DropdownSearch({
	...
	return (
		<div
			className={
				isDisabled
					? 'v2-project-container v2-project-container_disable'
					: 'v2-project-container'
			}
		>
			<div className={'v2-project-container dropdown'}>
				{selectedValue && Object.keys(selectedValue).length > 0 && (
					<Autocomplete
						data-testid={`v2-project-container-dropdown-input`}
						id="combo-box-demo"
						disabled={isDisabled}
						options={options}
						disablePortal
