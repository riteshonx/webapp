...
import './CommonAddMaterialTable.scss';
...
const CommonAddMaterialTable = (props: any) => {
  const {
    open,
    setAddMaterialPop,
    addMaterial,
  ...
  return (
    <CustomDialog
      data-testid="common-add-material-popup"
      open={open}
      onClose={() => {
      ...
      className="common-add-material-popup"
    >
      <div className="common-add-material-popup-title">
        <DialogTitle className="common-add-material-popup-title-heading">
          Add Material
        </DialogTitle>
        <div>
          <TextFieldCustom
            data-testid="task-name"
            className="common-add-material-popup-title-search"
            placeholder="Search"
            name="text"
            value={searchText}
            searchIcon={true}
      ...
      <DialogContent
        className={`common-add-material-popup-content ${
          materials.length === 0
            ? 'common-add-material-popup-content-empty'
            : ''
        }`}
      >
        ...
        {materials.length > 0 && (
          <TableContainer className="common-add-material-table-container">
            <Table
              stickyHeader
              ...
              <TableHead>
                <TableRow>
                  <TableCell padding="checkbox">
                    <Checkbox
                      className="common-add-material-table-head-checkbox"
                      color="default"
                      indeterminate={
                  ...
                  <TableCell className="common-add-material-table-head-cell common-add-material-table-head-cell-1">
                    <CustomToolTip
                      element={materialHeaderInfo?.materialName}
                      textLength={materialHeaderInfo?.CUSTOM_TEXT_LENGTH}
                    />
                  </TableCell>
                  <TableCell className="common-add-material-table-head-cell common-add-material-table-head-cell-2 ">
                    ID
                  </TableCell>
                  <TableCell className="common-add-material-table-head-cell common-add-material-table-head-cell-1">
                    <CustomToolTip
                  ...
                  <TableCell className="common-add-material-table-head-cell common-add-material-table-head-cell-3">
                    Unit
                  </TableCell>
                  <TableCell className="common-add-material-table-head-cell common-add-material-table-head-cell-3">
                    <CustomToolTip
                      ...
                      textLength={materialHeaderInfo?.CUSTOM_TEXT_LENGTH}
                      className="common-add-material-table-head-cell-3-customToolTip"
                    />
                  </TableCell>
                  <TableCell className="common-add-material-table-head-cell common-add-material-table-head-cell-3">
                    <CustomToolTip
                  ...
                  {/* <TableCell className="common-add-material-table-head-cell common-add-material-table-head-cell-4">
                    Type
                  </TableCell> */}
                  <TableCell className="common-add-material-table-head-cell common-add-material-table-head-cell-5">
                    Type
                  </TableCell>
                </TableRow>
              </TableHead>
              <TableBody className="common-add-material-table-body">
                {materials.map((row: any, index: any) => {
                  ...
                  return (
                    ...
                    >
                      <TableCell padding="checkbox">
                        <Checkbox
                          className="common-add-material-table-body-checkbox"
                          color="default"
                      ...
                      >
                        <CustomToolTip
                          ...
                          className="common-add-material-table-body-materialName"
                        />
                      </TableCell>
                      <TableCell>
                        <CustomToolTip
      ...
      <DialogActions className="common-add-material-popup-footer">
        <Button
          onClick={() => {
            setAddMaterialPop(false);
          }}
          variant="outlined"
          className="btn-secondary common-add-material-popup-footer-discard"
        >
          Discard
        </Button>
        <Button
          ...
          className="btn-primary common-add-material-popup-footer-add-material"
...
export default CommonAddMaterialTable;
