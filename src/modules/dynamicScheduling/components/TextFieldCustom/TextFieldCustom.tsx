  ...
  return (
    <div className="form">
      <div className={`form-group ${className}`}>
        ...
        {error && !errorIconVisible ? <InfoIcon className="text_field_custom-info-icon"></InfoIcon>:''}
        ...
        {error && <div className={`error ${errorColor ? 'custom-error-color' : ''}`}> {error} </div>}
      </div>
    </div>
  );
};
...
TextFieldCustom.propTypes = {
  ...
  errorIconVisible:PropTypes.bool
};
