...
import EditRecipeTaskResources from '../EditRecipeTaskResources/EditRecipeTaskResources';
...
import './EditRecipeTaskDetailsRightPanel.scss';
...
const EditRecipeTaskDetailsRightPanel = (props: any) => {
  const { editMode, isEditingRecipe } = props;
  ...
  return (
    <React.Fragment>
      ...
      {activeTab == 'resources' ? <EditRecipeTaskResources isEditingRecipe={isEditingRecipe} /> : ''}
    </React.Fragment>
  );
};

export default EditRecipeTaskDetailsRightPanel;
