...
import EditProjectPlanLinksContext from 'src/modules/dynamicScheduling/context/editProjectPlanLinks/editProjectPlanLinksContext';
...
import './EditTaskDetailsViewConstraints.scss';
...
const EditTaskDetailsViewConstraints = (props: any) => {
  ...
  const { fetchFormFeatures, formFeatures } = editProjectPlanLinksContext;
  ...
  const { updateLinkedForm } = editProjectPlanLinkContext;
  ...
  const changeStatus = (index: any) => {
    if (!permissionKeys(currentTask?.assignedTo).update) {
      return;
    }
  ...
  return (
    <div
      className="edit-task-detail-view__constraints"
    ...
    >
      {currentTaskConstraint &&
        ...
        !authContext.state.isLoading && (
          <div className="edit-task-detail-view__constraints__empty">
            <img
              src={EmptyConstraints}
              className="edit-task-detail-view__constraints__empty-img"
              alt="No Constraints"
              data-testid="edit-task-details-view-constraints-empy-img"
            />
            <span className="edit-task-detail-view__constraints__empty-text">
            ...
            {currentTask.type === 'wbs'
              ...
              : permissionKeys(currentTask?.assignedTo).create && (
                  <Button
                    ...
                    variant="outlined"
                    className="btn-text edit-task-detail-view__constraints__empty-add-constraint"
                    onClick={() => {
                      setEditMode(false);
                      setAddNewConstraint({
                        create: true,
      ...
      {currentTaskConstraint && currentTaskConstraint.length > 0 && (
        <div className="edit-task-detail-view__constraints__data">
          <div className="edit-task-detail-view__constraints__data__table-header">
            <div className="edit-task-detail-view__constraints__data__table-header__item-1">
              Title
            </div>
            <div className="edit-task-detail-view__constraints__data__table-header__item-2">
              Category
            </div>
            <div className="edit-task-detail-view__constraints__data__table-header__item-3">
              Description
            </div>
            <div className="edit-task-detail-view__constraints__data__table-header__item-4">
              Assignee
            </div>
            <div className="edit-task-detail-view__constraints__data__table-header__item-5">
              Due Date
            </div>
            <div className="edit-task-detail-view__constraints__data__table-header__item-6">
              Created by
            </div>
            <div className="edit-task-detail-view__constraints__data__table-header__item-7">
              Created on
            </div>
            <div className="edit-task-detail-view__constraints__data__table-header__item-8">
              Resolved by
            </div>
            <div className="edit-task-detail-view__constraints__data__table-header__item-9">
              Resolved on
            </div>
            <div className="edit-task-detail-view__constraints__data__table-header__item-10"></div>
            <div className="edit-task-detail-view__constraints__data__table-header__item-11"></div>
          </div>
          {constraintList.map((item: any, index: number) => (
            <div
              key={item.id}
              className="edit-task-detail-view__constraints__data__body__item"
            >
              {/* <Grid
                container
                ...
                className={`edit-task-detail-view__constraints__data__body__item ${
                  index == 0
                    ? 'edit-task-detail-view__constraints-border-top'
                    : ''
                }`}
              > */}
              <div
                className="edit-task-detail-view__constraints__data__body__item__name"
                ...
                >
                  {item.status == 'open' ? (
                    <div
                      ...
                      className="edit-task-detail-view__constraints__data__body__item__status__uncheck"
                    ></div>
                  ) : (
                    // <Tooltip title="click to open constraint">
                    <CheckCircleIcon
                      onClick={() => changeStatus(index)}
                      className="edit-task-detail-view__constraints__data__body__item__status__check"
                    />
                  )}
                </Tooltip>
                {!item.isEdit ? (
                  item.linkFormTask ? (
                    ...
                    >
                      <span
                        className={`edit-task-detail-view__constraints__data__body__item__name-text ${
                          item.linkFormTask
                            ? 'edit-task-detail-view__constraints__data__body__item__name-text-hiperlink'
                            : ''
                        }`}
                        onClick={() => {
                ...
                {item.isEdit && (
                  <div>
                    <TextField
                      ...
                      className="edit-task-detail-view__constraints__data__body__item__name__input"
                    ...
                    {editedConstraint?.constraintName?.length > 30 && (
                      <div className="edit-task-detail-view__constraints__data-add-constraint-input-text__error">
              ...
              <div
                ...
                className={`edit-task-detail-view__constraints__data__body__item__category ${
                  !item.isEdit
                    ? 'edit-task-detail-view__constraints__data__body__item__category-heading'
                    : ''
                }`}
              >
                {item.isEdit && (
                  <FormControl variant="outlined" fullWidth>
                    ...
                    >
                      <option
                        value=""
                        className="edit-task-detail-view__constraints__data__body__item__category-option"
                      >
                        Select a category
                      </option>
                      {categoryList
                        .filter((cat: any) => cat.value != 'Form')
              ...
              <div
                ...
                className="edit-task-detail-view__constraints__data__body__item__description"
              >
                {!item.isEdit && (
                ...
                {item.isEdit && (
                  <div>
                    <TextField
                      ...
                      className=" edit-task-detail-view__constraints__data__body__item__description-input"
                      variant="outlined"
              ...
              <div
                ...
                className="edit-task-detail-view__constraints__data__body__item__assignee"
              >
                {!item.isEdit && (
                  <span>
                    {' '}
                ...
                {item.isEdit && (
                  <div className="edit-task-detail-view__constraints__singleUserSelect">
                    <div className="edit-task-detail-view__constraints__singleUserSelect__search">
                      <SearchIcon className="edit-task-detail-view__constraints__singleUserSelect__search__icon" />
                      <TextField
                        value={searchName}
                      ...
                      {searchName && (
                        <IconButton
                          ...
                          className="edit-task-detail-view__constraints__singleUserSelect__search__close"
                        >
                          <CancelIcon className="edit-task-detail-view__constraints__singleUserSelect__search__close__icon" />
                        </IconButton>
                      )}
                    </div>
                    {showAssigneeOption && (
                      <div className="edit-task-detail-view__constraints__singleUserSelect__option">
                        <div className="edit-task-detail-view__constraints__singleUserSelect__option__list">
                          {assigneeList.map(
                            (item: any, searchIndex: number) => (
                              <div
                                key={item.id}
                                className="edit-task-detail-view__constraints__singleUserSelect__option__list__item"
                                style={{
                                  borderBottom: `${
                              ...
                              >
                                <div className="edit-task-detail-view__constraints__singleUserSelect__option__list__item__left">
                                  <div className="edit-task-detail-view__constraints__singleUserSelect__option__list__item__left__label">
                                    <div className="edit-task-detail-view__constraints__singleUserSelect__option__list__item__left__label__name">
                                      {item.name
                                        ? item.name
              ...
              <div
                ...
                className="edit-task-detail-view__constraints__data__body__item__due-date"
              >
                {!item.isEdit && (
                  <span>
                    {item.dueDate
              ...
              <div
                ...
                className="edit-task-detail-view__constraints__data__body__item__createdby"
              >
                <Tooltip
              ...
              <div
                ...
                className="edit-task-detail-view__constraints__data__body__item__createdon"
              >
              ...
              <div
                ...
                className="edit-task-detail-view__constraints__data__body__item__resolvedby"
              >
                {item.status === 'closed'
              ...
              <div
                ...
                className="edit-task-detail-view__constraints__data__body__item__resolvedon"
              >
                {item.status === 'closed' ? (
                  moment(item.updatedAt).format('DD MMM yyyy')
                ) : (
                  <span className="edit-task-detail-view__constraints__data__body__item__resolvedon-open">
                    Open
                  </span>
                )}
              </div>

              {!item.isEdit && permissionKeys(currentTask?.assignedTo).create && (
                <div
                  data-testid="constraint-btn"
                  className="edit-task-detail-view__constraints__data__body__item__btn"
                >
                  {item.status === 'open' && !item.linkId ? (
                    <img
                      ...
                      src={editIcon}
                      alt="edit constraint"
                      className="edit-task-detail-view__constraints__data__body__item__btn-edit"
                      onClick={() => {
              ...
              {!item.isEdit && permissionKeys(currentTask?.assignedTo).create && (
                <div
                  data-testid="constraint-btn"
                  className="edit-task-detail-view__constraints__data__body__item__btn__delete"
                >
                  <img
                    data-testid="constraint-btn-delete"
                    src={deleteIcon}
                    className="edit-task-detail-view__constraints__data__body__item__btn-delete"
                    alt="delete constraint"
                    onClick={() => !addNewConstraint.create && deleteItem(item)}
                  />
                </div>
              )}
              ...
              {item.isEdit && permissionKeys(currentTask?.assignedTo).create && (
                <div
                  data-testid="constraint-btn"
                  className="edit-task-detail-view__constraints__data__body__item__btn-save"
                >
                  <Button
                    ...
                    variant="outlined"
                    className="btn-primary edit-task-detail-view__constraints__data__body__item__btn-save-update"
                    disabled={
                  ...
                  <div>
                    <Button
                      ...
                      className=" btn-text edit-task-detail-view__constraints__data__body__item__btn-save-discard "
                    >
                      Discard
                    </Button>
                  </div>
      ...
      {addNewConstraint.create ? (
        <div className="edit-task-detail-view__constraints__data-add-constraint-input">
          <div>
            <TextField
              data-testid="constraint-name-input"
              className={`edit-task-detail-view__constraints__data-add-constraint-input-text`}
          ...
          <FormControl variant="outlined">
            <Select
              ...
              name="category"
              onChange={(e) => onNewConstrintChange(e)}
              className="edit-task-detail-view__constraints__data-add-constraint-input-category"
              id="demo-simple-select-outlined"
              onKeyDown={onKeyPress}
            >
          ...
          <div>
            <TextField
              ...
              className={`edit-task-detail-view__constraints__data-add-constraint-input-description`}
              onChange={(e) => onNewConstrintChange(e)}
              name="description"
          ...
          <FormControl variant="outlined">
            <div className="edit-task-detail-view__constraints__singleUserSelect edit-task-detail-view__constraints__data-add-constraint-input-assignee">
              <div className="edit-task-detail-view__constraints__singleUserSelect__search">
                <SearchIcon className="edit-task-detail-view__constraints__singleUserSelect__search__icon" />
                <TextField
                  value={searchName}
          ...
          <MuiPickersUtilsProvider utils={DateFnsUtils}>
            <GlobalKeyboardDatePicker
              ...
              className="edit-task-detail-view__constraints__data-add-constraint-input-due-date"
              variant="inline"
              inputVariant="outlined"
      ...
      permissionKeys(currentTask?.assignedTo).create ? (
        <Button
          ...
          className="btn-text edit-task-detail-view__constraints__data-add-constraint-btn"
          onClick={() => {
            setEditMode(false);
            setAddNewConstraint({
              create: true,
      ...
      <Popover
        ...
        disableRestoreFocus
      >
        <table className="edit-task-detail-view__constraints__form-name__popover__table">
          <tr className="edit-task-detail-view__constraints__form-name__popover__table__tr">
            <th className="edit-task-detail-view__constraints__form-name__popover__table__tr__th">
              Form Id
            </th>
            <td className="edit-task-detail-view__constraints__form-name__popover__table__tr__td">
          ...
          <tr className="edit-task-detail-view__constraints__form-name__popover__table__tr">
            ...
            <td className="edit-task-detail-view__constraints__form-name__popover__table__tr__td edit-task-detail-view__constraints__form-name__popover__table__tr__td-5">
              <span>
                {' '}
                {currentConstraintRow?.linkFormTask &&
              ...
              <span className="edit-task-detail-view__constraints__form-name__popover__table__tr__td-5-email">
                {currentConstraintRow?.linkFormTask &&
                currentConstraintRow?.linkFormTask?.form.formsUserLists.length >
                  0
                  ? currentConstraintRow?.linkFormTask?.form.formsUserLists[0]
...
export default EditTaskDetailsViewConstraints;
