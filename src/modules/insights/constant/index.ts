export const LESSONS_LEARNED_TAB = 'lessonsLearned';
export const SCHEDULE_TAB = 'schedule';
export const SCHEDULE_IMPACT_TAB = 'scheduleImpact';
...
export const SCHEDULE_IMPACT_TYPES = {
  RFI: 'rfi',
  DAILY_LOGS: 'dailylogs',
  WEATHER: 'weather',
  MATERIAL: 'material',
  CONSTRAINT_LOGS: 'constraintlogs',
};
