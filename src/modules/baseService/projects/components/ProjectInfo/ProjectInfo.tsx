...
import { setProjecDetailsDirty, setProjectInfo } from '../../Context/ProjectDetailsActions';
...
export default function ProjectInfo(props: any): ReactElement {
    ...
    const getRenderValue=(argValue: Array<number>): any=>{
        ...
        if (argValue.length === 0) {
            return <div className="projectInfo__wrapper__form__body__label__text">Select Portfolio</div>;
        }
    ...
    const getRenderValueForState=(selected:any)=>{
        ...
        if (selected.length === 0 || !val) {
          return <div className="projectInfo__wrapper__form__body__label__text">Select State</div>;
        }
        return selected;
      }
    ...
    return (
            <div className="projectInfo__wrapper">
                <div className="projectInfo__wrapper__project-image">
                    <img className="img-responsive" src={projectIcon} alt="user" />
                </div>
                <div className="projectInfo__wrapper__header">
                            Project Info
                </div>
                <form className="projectInfo__wrapper__form" onSubmit={handleSubmit(onSubmit)}>
                    <div className="projectInfo__wrapper__form__body">
                        <div className="projectInfo__wrapper__form-wrapper">
                            
                            <Grid container className="projectInfo__wrapper__form__body__container">
                                <Grid item xs={4} className="projectInfo__wrapper__form__body__label">
                                    <InputLabel required={true}>Name </InputLabel>
                                </Grid>
                                <Grid item xs={8} className="projectInfo__wrapper__form__body__input-field">
                                    <Controller 
                                    ...
                                    />
                                    <div className="projectInfo__wrapper__error-wrap">
                                            <p className="projectInfo__wrapper__error-wrap__message">
                                                {
                            ...
                            <Grid container className="projectInfo__wrapper__form__body__container">
                                ...
                                <Grid item xs={8} className="projectInfo__wrapper__form__body__input-field">
                                    ...
                                    />
                                    <div className="projectInfo__wrapper__error-wrap">
                                            <p className="projectInfo__wrapper__error-wrap__addressmessage">
                                                {
                                                   addressRequired && (
                                    ...
                                    <Controller
                                        render={({ field }:{field:any}) => (
                                            <TextField
                                                ...
                                                onChange={(e) =>{ field.onChange(e),projectDetailsDispatch(setProjecDetailsDirty(true));}}
                                            />                      
                                        )}
                                        name= "addressLine2"
                                        control={control}
                                     ...
                                     <Controller 
                                            render={({ field }:{field:any}) => (
                                                <Select
                                                    ...
                                                    renderValue={
                                                        field.value !== "" ? undefined : () => <div className="projectInfo__wrapper__form__body__label__text">Select Country</div>
                                                    }
                            ...
                            <Grid  className="projectInfo__wrapper__form__body__container">
                                <Grid item xs={4} className="projectInfo__wrapper__form__body__label">
                                    <InputLabel required={true}>Start Date </InputLabel>
                                </Grid>
                            <Grid item xs={8} className="projectInfo__wrapper__form__body__input-portfolio-field">
                            <MuiPickersUtilsProvider libInstance={moment} utils={MomentUtils}>
                                    ...
                                    />
                                    <div className="projectInfo__error-wrap">
                                                <p className="projectInfo__error-wrap__message">
                                                    {
                    ...
                    {(canUpdateProject || projectDetailsState?.projectUpdatePermission?.canUpdateMyProject)&&
                     ( <div className="projectInfo__wrapper__form__action">
