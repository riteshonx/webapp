...
export const FETCH_PROJECT_ASSOCIATED_USERS_BY_FULLNAME= gql`query fetchProjectAssociatedUsers($projectId: Int!, $fName: String!, $lName: String!) {
  projectAssociation(where: {projectId: {_eq: $projectId},  user: {
    _and: {
...
export const FETCH_PROJECT_ASSOCIATED_USERS_BY_FULL_NAME= gql`query fetchProjectAssociatedUsers($projectId: Int!, $fName: String!) {
  projectAssociation(where: {projectId: {_eq: $projectId},  user: {
    _and: {
      lastName: {_ilike: $lName},
       _or:[
