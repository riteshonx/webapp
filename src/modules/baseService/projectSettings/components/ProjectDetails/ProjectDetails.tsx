...
import { setProjecDetailsDirty, setProjectMetricsDetails } from '../../../projects/Context/ProjectDetailsActions';
...
export default function ProjectDetails(props: any): ReactElement {
    ...
    return (
        <div className="projectsettingDetails">
            <div className="projectsettingDetails__description">
                Make further adjustments to this project by adding more information below.
            </div>
            <div  className="projectsettingDetails__metrics">
                <div className="projectsettingDetails__metrics__container">
                    <div className="projectsettingDetails__metrics__label">
                        <InputLabel required={false}>Type</InputLabel>
                    </div>
                    <div className="projectsettingDetails__metrics__input-field">
                        <Controller 
