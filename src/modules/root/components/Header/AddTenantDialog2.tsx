...
import SlateWhiteLogo from "../../../../assets/images/Logo_v2.svg";
...
const useStyles: any = makeStyles((theme: any) => ({
  ...
  submitButton:{
    color:'#fe9a0b !important',
    border:"2px solid #fe9a0b",
    "& .Mui-disabled":{
      color:'#fe9a0b',
      borderColor:"2px solid #fe9a0b",
      opacity:"0.2"
    }
  },
  textField: {
  ...
  return (
    <Dialog open={openDialog} classes={{ paper:dialogClasses.dialogPaper }} >
      <Grid>
        ...
        <Grid container justify="center">
          <h3 style={{ marginTop: "5px", color:'white' }}>Add Account</h3>
        </Grid>
        <Grid container justify="center">
        ...
        <Grid container justify="center">
          <Grid item xs={12} className={"createTenant-textcell__company"}>
            <Autocomplete
              ...
              // className="createTenant-textcell__company__list"
              className={dialogClasses.autoComplete}
              selectOnFocus
              handleHomeEndKeys
              ...
              renderInput={(params) => (
                <TextField
                  ...
                  type="text"
                //   variant="filled"
                  placeholder="Company Name For Account"
                />
              )}
            />
            {hasNoCompanyName && (
        ...
        <Grid container justify="center">
          <Grid item xs={12} className={"createTenant-textcell__location"}>
            <Autocomplete
                  ...
                  handleHomeEndKeys
                  value={inputValue}
                  // className="createTenant-textcell__company__address"
                  className={dialogClasses.autoComplete}
        ...
        <Grid container justify="center">
          <Grid item xs={12}>
            <Button
              ...
              style={{cursor: !userEmail && !companyName ? "none":"pointer"}}
              fullWidth
              className={`"btn-primary" ${dialogClasses.submitButton}`}
...
export default AddTenantDialog2;
